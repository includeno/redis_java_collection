...
import com.redisexample.service.IRedPacketService;
import com.redisexample.util.BaseResponse;
import com.redisexample.util.StatusCode;
    ...
    public BaseResponse rob(@RequestParam Integer userId, @RequestParam String redId){
        ...
        try {
            ...
            if (result!=null){
                ...
                response=new BaseResponse(StatusCode.Fail,"红包已被抢完!");
            }
        }catch (Exception e){
